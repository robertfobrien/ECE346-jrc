...
class BaseCost(ABC):
	...
	@partial(jax.jit, static_argnums=(0,))
	def get_traj_cost(
			self, trajectory: jax.Array, controls: jax.Array, path_refs: jax.Array
	) -> float:
		'''
...
@jax.jit
def exp_linear_cost(
		y: Union[float, jax.Array], a: Union[float, jax.Array] = 1,
		b: Union[float, jax.Array] = 1
