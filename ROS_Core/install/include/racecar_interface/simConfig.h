...
// *********************************************************
//
// File autogenerated for the racecar_interface package
// by the dynamic_reconfigure package.
// Please do not edit.
//
// ********************************************************/

#ifndef __racecar_interface__SIMCONFIG_H__
#define __racecar_interface__SIMCONFIG_H__
...
namespace racecar_interface
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(simConfig &config, const simConfig &max, const simConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const simConfig &config1, const simConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, simConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const simConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, simConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const simConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const simConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, simConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
  ...
  public:
    ...
    void setParams(simConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
      {
        ...
        if("throttle_noise_sigma"==(*_i)->name){throttle_noise_sigma = boost::any_cast<double>(val);}
        if("steer_noise_sigma"==(*_i)->name){steer_noise_sigma = boost::any_cast<double>(val);}
        if("latency"==(*_i)->name){latency = boost::any_cast<double>(val);}
      }
    }

    double throttle_noise_sigma;
double steer_noise_sigma;
double latency;
...
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.throttle_noise_sigma = 0.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.throttle_noise_sigma = 5.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.throttle_noise_sigma = 0.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(simConfig::AbstractParamDescriptionConstPtr(new simConfig::ParamDescription<double>("throttle_noise_sigma", "double", 0, "An Integer parameter", "", &simConfig::throttle_noise_sigma)));
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(simConfig::AbstractParamDescriptionConstPtr(new simConfig::ParamDescription<double>("throttle_noise_sigma", "double", 0, "An Integer parameter", "", &simConfig::throttle_noise_sigma)));
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.steer_noise_sigma = 0.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.steer_noise_sigma = 5.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.steer_noise_sigma = 0.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(simConfig::AbstractParamDescriptionConstPtr(new simConfig::ParamDescription<double>("steer_noise_sigma", "double", 0, "A double parameter", "", &simConfig::steer_noise_sigma)));
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(simConfig::AbstractParamDescriptionConstPtr(new simConfig::ParamDescription<double>("steer_noise_sigma", "double", 0, "A double parameter", "", &simConfig::steer_noise_sigma)));
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __min__.latency = 0.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __max__.latency = 1.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.latency = 0.0;
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(simConfig::AbstractParamDescriptionConstPtr(new simConfig::ParamDescription<double>("latency", "double", 0, "A double parameter", "", &simConfig::latency)));
//#line 291 "/Users/colemeyer/miniforge3/envs/ros_base/lib/python3.9/site-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(simConfig::AbstractParamDescriptionConstPtr(new simConfig::ParamDescription<double>("latency", "double", 0, "A double parameter", "", &simConfig::latency)));
